...
class Player(Base):
    ...
    primary_assists = Column(Float, default=0)
    dzone_giveaways = Column(Float, default=0)
    onice_fenwick_pct = Column(Float, default=0)
    onice_corsi_pct = Column(Float, default=0)
    onice_xgoals_pct = Column(Float, default=0)
